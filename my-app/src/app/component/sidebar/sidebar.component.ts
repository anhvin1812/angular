...
import { SidebarComponent as BaseSidebarComponent } from '../../../assets/style/theme/components/sidebar';

@Component({
  selector: 'app-sidebar',
  styleUrls: ['../../../assets/style/theme/components/sidebar/sidebar.component.scss', './sidebar.component.scss'],
  templateUrl: '../../..//assets/style/theme/components/sidebar/sidebar.component.html',
})
